...
SECRET_KEY = '$sc8_+6_br1=xigkn*9am8v1@1^bjp6%jk^ayhhaw%b%cb-9n1'
...
WSGI_APPLICATION = 'hand_shop.wsgi.application'
...
EMAIL_HOST_PASSWORD = 'yousef1995$'
###########end email############
